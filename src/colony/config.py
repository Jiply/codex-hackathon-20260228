...
MARKET_SEED = int(os.getenv("MARKET_SEED", "17"))
MARKET_TASKS_PER_TICK = int(os.getenv("MARKET_TASKS_PER_TICK", "3"))
MARKET_MAX_OPEN_LISTINGS = int(os.getenv("MARKET_MAX_OPEN_LISTINGS", "8"))
MARKET_LISTING_TTL_TICKS = int(os.getenv("MARKET_LISTING_TTL_TICKS", "3"))
MARKET_OBSERVATION_NOISE = float(os.getenv("MARKET_OBSERVATION_NOISE", "0.35"))
MARKET_TOOL_MISS_PENALTY = float(os.getenv("MARKET_TOOL_MISS_PENALTY", "0.25"))
MARKET_SKILL_MISS_COST_MULTIPLIER = float(
    os.getenv("MARKET_SKILL_MISS_COST_MULTIPLIER", "0.7")
)
